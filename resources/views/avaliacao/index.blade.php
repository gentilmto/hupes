  ...
  <div class="panel panel-primary">
             ...
             <button id="btn_add" name="btn_add" class="btn btn-default pull-right">Adicionar Novo</button>
                ...
                <tbody id="products-list" name="products-list">                      
                     <!--  <td>{{$avaliacao->id}}</td>
                      <td>{{$avaliacao->notificacoes->dataEntrada}}</td>
                      <td>{{$avaliacao->status or 'aguardando'}}</td>
                      <td>{{$avaliacao->notificacoes->paciente_protuario or '10'}}</td>
                        
                       -->

                      <td>
                          <button class="btn btn-warning btn-detail open_modal" value="{{$avaliacao->id}}">Edit</button>
                          <button class="btn btn-danger btn-delete delete-product" value="{{$avaliacao->id}}">Delete</button>
                     </td>                                       
                </tbody>
            </table>
      </div>
