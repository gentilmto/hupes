...
<div class="panel panel-primary">
     <div class="panel-heading">MEDICAMENTOS SUSPEITOS
          ...
          <div class="panel-body" class="col-md-9 col-md-offset-1"> 
           <table class="table table-responsive table-bordered table-striped"  style=" height: 100px; overflow-y: scroll;"  id="tamed">
                    <thead>
                      <tr>
                        ...
                        <th><div><label >Dose Diaria:</label></div></th>
                        <th><div><label >Data Inicio:</label></div></th>
                        <th><div><label >Data Fim do uso:</label></div></th>
                        <th><div><label >Indicação Terapeutica:</label></div></th>
                        <th><div><label >Ação</label></div></th>
                        <th><div><label >Ação</label></div></th>
                      </tr>
                     </thead>
...
<div class="panel panel-primary">
 ...
 <button onclick="linhaAdd2()"  type="button" class="btn btn-default pull-right"> Medicamento Suspeito</button>
...
(function($) {
                    linhaAdd2 = function(item) {
    var table = $('#tamed2').DataTable();
     var counter = 1;
    table.row.add( [
                     ...
                     '<td><div><input class="indTera" type="text" class="form-control"  id="indTera" name="indTera[]" placeholder="Indicação Terapeitica.."></div></td>',
                     '<td><input class="indTera" type="text" class="form-control"  id="indTera" name="indTera[]" placeholder="Indicação Terapeitica.."></td>',
                     '<td><input class="indTera" type="text" class="form-control"  id="indTera" name="indTera[]" placeholder="Indicação Terapeitica.."></td>',
