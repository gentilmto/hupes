...
<div class="panel panel-primary">
 <div class="panel-heading">HUPES CADASTRO
      ...
      <div class="panel-body"> 
       <table class="table table-responsive"  style=" height: 100px; overflow-y: scroll;"  id="tamed">
        <thead>
          <tr>
...
<div class="row"  style=" height: 200px; overflow-y: scroll;" id="grade">
            ...
            <div class ="box-body">
                ...
                <div class="row" id="ram">
                    <div class="col-xs-6"><h3>REAÇÕES DIVERSAS</h3>

                    <input name="reacAdv"class="col-xs-6" ></div>
